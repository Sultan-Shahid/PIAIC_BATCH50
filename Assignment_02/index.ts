...
var Fahrenheit:number=45;
var Result_C_TO_F:number=(Celsius * 9/5) + 32;
var Result_F_TO_C:number=(Fahrenheit - 32) * 5/9;
...
var Obtain_Marks:number=971;
var per:number=Obtain_Marks*100/Total_Marks;
...
var ResultWeek:number=Math.floor(GivenDays/7);
var ResultDay:number=GivenDays%7;
...
var Price_Of_Product:number=120;

var discount10:number=Price_Of_Product-(Price_Of_Product*10/100);
var discount5:number=Price_Of_Product-(Price_Of_Product*5/100);
...
var Consumed_Units:number=120;

var Tax100:number=Consumed_Units+(Consumed_Units*10/100);
var Tax200:number=Consumed_Units+(Consumed_Units*15/100);
var Tax500:number=Consumed_Units+(Consumed_Units*500/100);
if(Consumed_Units<=100)
{
    console.log("Your Actual Consumed Units "+ Consumed_Units)
    console.log("Your Units After Add 0% Tax : "+ Consumed_Units)
}
else if(Consumed_Units>100 || Consumed_Units<=200  )
{
    console.log("Your Actual Consumed Units "+ Consumed_Units)
    console.log("Your Units After Add 10% Tax : "+ Tax100)
}
else if(Consumed_Units>200 ||Consumed_Units<=500 )
{
    console.log("Your Actual Consumed Units "+ Consumed_Units)
    console.log("Your Units After Add 15% Tax  : "+ Tax200)
}
else
{
    console.log("Your Actual Consumed Units "+ Consumed_Units)
    console.log("Your Units After Add 25% Units : "+ Tax500)
}