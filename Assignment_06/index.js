...
let titlecase = (str) => {
    ...
    var Array = str.split(" ");
    var upgrade = Array.map((word) => {
        return Captalize_Word(word);
    });
    const result = upgrade.join(" ");
    return result;
};
var val = "suLtan sHahid";
...
console.log();
var Favourite_Number = 18;
var Message = `My Favourite Number Is : ${Favourite_Number}`;
console.log(Message);
console.log();
...
console.log();
var Names_Friend = ["Ali", "Ahmad", "wali", "Anus"];
...
*/
console.log();
var transportation = ["Car", "MotorCycle", "HeavyBike", "Train", "AeroPlane"];
...
console.log();
var Guest_List = ["Abdullah", "Saad", "Umer"];
...
console.log();
var plcaeToVisit = ["paris", "karachi", "lahore", "Islamabad"];
// • Print your array in its original order.
plcaeToVisit.forEach((elem) => {
    console.log(elem);
});
...
console.log();
let Countries = [{ name: "Uk", populationn: 23456778 }, { name: "pakistan", populationn: 22000332 }, { name: "India", populationn: 70442344 }];
...
console.log();
var favorite_fruits = ["Apple", "Mango", "Graps"];
...
console.log();
var username = ["Ali", "wali", "ahmad", "admin", "Eric"];
...
*/
console.log();
var current_username = ["Ali", "wali", "ahmad", "abdullah", "Eric"];
var new_username = ["Sultan", "ramish", "ahmad", "Faizan", "Usman"];
...
console.log();
function make_album(artist_name, album_title, Nm_Track) {
    let music_album = {
...
console.log();
var Magician_Name = ["Shahid", "Wahad", "Moiz"];
...
var Magician = ["Mahad", "Ali", "Rahat"];
var newarray = [];
function make_Greattt(Magician) {
...
*/
function item_On_SandWich(...arrray) {
...
stored correctly.
*/
function info_Car(manufacturer, model_name, color, price) {
    let car = {
