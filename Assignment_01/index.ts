...
console.log(" Hey Muhammad Sultan, I have started learning TYPESCRIPT. ");
console.log("\n"); //for new line
...
var myname:string = "Muhammad Sultan Shahid";
console.log(myname);
...
var result:number = num1 + num2 * num3 + num4 / num5 + num6 + num7 + num8 + num9 + num10; // In this answer given according its precedence
