...
var Names = ["Ali", "Ahmad", "Wali"];
function Modified_Array(Names, index, New_Name) {
    Names.splice(index, 0, New_Name);
    return Names;
}
var Arraay = Modified_Array(Names, 1, "Sultan");
console.log(Arraay);
console.log(); // For New Line 
//-- Implement a simple shopping cart program using an array. Create functions to add items, remove items, and update quantities using the splice method. Print the cart's contents after each operation
var Shopping_Cart = ["2-Lux Soap", "1kg-Rice", "2_Dozen-Egg"];
...
function Calculate_Factorial(Value) {
    if (Value >= 0) {
        var i = 1;
        var fact = 1;
        while (i <= Value) {
...
var Array_Marks = [12, 13, -2, 12, -3, 31];
...
var Temp_In_Celcius = [40, 38, 39, 30, 25];
